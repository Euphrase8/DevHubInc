    ...
    <footer className="bg-card/30 border-t border-border py-12 relative overflow-hidden">
        ...
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            >
              ...
              />
              <polygon
                points="25,30 40,50 25,70 10,50"
                fill="currentColor"
                className="text-primary"
                opacity="0.5"
              />
              <polygon
                points="75,40 85,55 75,70 65,55"
                fill="currentColor"
                className="text-primary"
                opacity="0.3"
              />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <img src={Logo} alt="DevHub Logo" className="h-12 w-auto mb-4" />
            <p className="text-muted-foreground">
              Building future-ready digital experiences with innovation and
              precision.
            </p>
          </div>
